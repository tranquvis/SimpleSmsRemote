    ...
    public ExecutionResult execute(Context context, MySms controlSms)
    {
        ...
        else
        {
            try
            {
                ...
                else if (this.equals(ControlCommand.BATTERY_LEVEL_GET))
                {
                ...
                else if (this.equals(ControlCommand.LOCATION_GET))
                {
                ...
                else if (this.equals(ControlCommand.AUDIO_SET_VOLUME))
                {
                    //TODO
                }
